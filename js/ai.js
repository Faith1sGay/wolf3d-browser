...
Wolf.AI = (function () {
  ...
  function chase (self, game) {
    ...
    var deltay
    var d = []
    var tdir; var olddir; var turnaround
  ...
  function projectileTryMove (self, level) {
    var PROJSIZE = 0x2000
    var xl; var yl; var xh; var yh; var x; var y
  ...
  function T_Projectile (self, game, tics) {
    var level = game.level
    var player = game.player
    var PROJECTILESIZE = 0xC000
    var deltax; var deltay
    var speed; var damage
