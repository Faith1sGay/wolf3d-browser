...
Wolf.Raycaster = (function () {
  ...
  var PUSHWALL_TILE = Wolf.PUSHWALL_TILE
  var TRACE_HIT_PWALL = Wolf.TRACE_HIT_PWALL
  var DOOR_FULLOPEN = Wolf.DOOR_FULLOPEN
  var XnextTable = Wolf.Math.XnextTable
  var YnextTable = Wolf.Math.YnextTable
  var getQuadrant = Wolf.Math.getQuadrant
  var TanTable = Wolf.Math.TanTable
  ...
  function traceCheck (tileMap, doorMap, visibleTiles, x, y, frac, dfrac, vert, flip, tracePoint) {
    ...
    if (tileMap[x][y] & PUSHWALL_TILE) {
      ...
      var offset = pwall.pointsMoved / 128
  ...
  function trace (level, visibleTiles, tracePoint) {
    var xtilestep; var ytilestep
    var xstep; var ystep
    var xtile; var ytile
    var xintercept; var yintercept
    var YmapPos; var XmapPos
    var tileMap = level.tileMap
    var doorMap = level.state.doorMap
    var q
  ...
  function traceRays (viewport, level) {
    ...
    var tracePoint
    var visibleTiles = []
    var numRays = Wolf.XRES / Wolf.SLICE_WIDTH
    var tracers = []
