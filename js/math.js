...
Wolf.Math = (function () {
  ...
  var CosTable = [] // SinTable + ANG_90,
  var TanTable = [] // [ ANG_360 + 1 ];

  var XnextTable = [] // [ ANG_360 + 1 ],
  var YnextTable = [] // [ ANG_360 + 1 ],

  var ColumnAngle = [] // [ 640 ]; // ViewAngle=PlayerAngle+ColumnAngle[curcolumn]; /in fines/

  // Angle Direction Types & LUTs (Hard Coded! Please do not mess them)
  var q_first = 0; var q_second = 1; var q_third = 2; var q_fourth = 3 // quadrant;
  var dir4_east = 0; var dir4_north = 1; var dir4_west = 2; var dir4_south = 3; var dir4_nodir = 4 // dir4type;

  var dir8_east = 0; var dir8_northeast = 1; var dir8_north = 2; var dir8_northwest = 3; var dir8_west = 4
  var dir8_southwest = 5; var dir8_south = 6; var dir8_southeast = 7; var dir8_nodir = 8 // dir8type;

  var dx4dir = [1, 0, -1, 0, 0] // dx & dy based on direction
  var dy4dir = [0, 1, 0, -1, 0]
  var dx8dir = [1, 1, 0, -1, -1, -1, 0, 1, 0] // dx & dy based on direction
  var dy8dir = [0, 1, 1, 1, 0, -1, -1, -1, 0]
  var opposite4 = [2, 3, 0, 1, 4]
  var opposite8 = [4, 5, 6, 7, 0, 1, 2, 3, 8]
  var dir4to8 = [0, 2, 4, 6, 8]
  var diagonal = [
  ...
  var dir8angle = [Wolf.ANG_0, Wolf.ANG_45, Wolf.ANG_90, Wolf.ANG_135, Wolf.ANG_180, Wolf.ANG_225, Wolf.ANG_270, Wolf.ANG_315, Wolf.ANG_0]
