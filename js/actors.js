...
Wolf.Actors = (function () {
  ...
  var r_add8dir = [4, 7, 6, 5, 0, 1, 2, 3, 0]
  ...
  function spawnBJVictory (player, level, skill) {
    ...
    var y = Wolf.POS2TILE(player.position.y)
    var bj = spawn(level, skill, Wolf.en_bj, x, y + 1, Wolf.Math.dir4_north)
